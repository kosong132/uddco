...
public class DashboardService {
    ...
    public List<Map<String, Object>> getSalesData(int year, int month) {
        ...
        DateTimeFormatter shortMonthFormatter = DateTimeFormatter.ofPattern("MMM", Locale.ENGLISH);
        ...
        try {
            ...
            for (DocumentSnapshot doc : docs) {
                ...
                if (createdAt == null || totalPrice == null) {
                    continue;
                }
                ...
                if (month == 0) {
                    // Monthly revenue
                   String monthKey = date.format(shortMonthFormatter).toUpperCase(); // "JAN", "FEB", etc.
                    salesMap.put(monthKey, salesMap.getOrDefault(monthKey, 0.0) + totalPrice);
